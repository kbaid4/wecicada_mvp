          ...
          <div className="event-detail-card" style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '15px' }}>
              ...
              <span style={{
                ...
                fontSize: '14px',
                fontWeight: 'bold',
                backgroundColor: eventDetails.is_placeholder ? '#FFEBCD' : '#E6F7FF',
                color: eventDetails.is_placeholder ? '#CD853F' : '#0073CF'
              }}>
                {eventDetails.status || (eventDetails.is_placeholder ? 'Invited' : 'Active')}
              </span>
            </div>
            ...
            <div className="event-info-grid" style={{ 
              ...
              {/* Budget Information - Only show if available */}
              {eventDetails.budget && (
                <div className="info-item" style={{
                  borderRadius: '8px',
                  padding: '15px',
